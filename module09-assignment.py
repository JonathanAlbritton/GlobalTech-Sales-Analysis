...
# Your code here
overall_total= sales_df['Total_Sales'].sum()
...
print("\nKEY BUSINESS RECOMMENDATIONS:")
print("1. Increase advertisment to gain more sales.")
print("2. Focus on regions with higher sales such as North America.")
print("3. Address missing pricing data.")